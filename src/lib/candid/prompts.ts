...
import type {
  ...
  CandidLearningBias,
  CandidMemory,
  CandidRetrievedMemory,
  CandidSocialMove,
  CandidSocialState,
  PresenceState,
} from "@/lib/candid/types";

export function buildCandidPrompt(input: {
  memory: CandidMemory;
...
export function buildAnalysisPrompt() {
  return `
infer what candid should remember about the user.
...
function formatRetrievedMemories(items: CandidRetrievedMemory[]) {
