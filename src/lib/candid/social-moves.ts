...
export function chooseSocialMove(input: {
  ...
  const candidates: CandidSocialMove[] = [];
  ...
  const fallback: CandidSocialMove[] = [
    "react",
    "curiosity_hook",
    "playful_assumption",
    "callback",
...
export function socialMoveInstruction(move: CandidSocialMove) {
  const instructions: Record<CandidSocialMove, string> = {
