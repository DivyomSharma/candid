...
export function CandorBadge({ badge, className }: CandorBadgeProps) {
    ...
    <div className={cn("flex flex-col items-center", className)}>
      ...
      >
        ...
        <div className="relative text-center">
          <p className="text-[10px] font-light uppercase tracking-[0.2em] text-accent/70">candor badge</p>
