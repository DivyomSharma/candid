...
export default function WaitlistSection() {
  ...
  const enterCandid = () => {
    window.location.href = "/candid/home";
  };
    ...
    <section id="waitlist" className="py-24 md:py-32 px-6">
      ...
      >
        ...
        <p className="text-foreground-secondary text-sm font-light mb-10 leading-7">
          every new profile begins with seven days of continuity. enough time for candid to feel more perceptive, not just more available.
        </p>
