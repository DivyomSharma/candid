...
export const metadata: Metadata = {
  ...
  description: "The core terms for using Candor responsibly.",
};
...
export default function TermsPage() {
  return (
    <TrustPageShell
      eyebrow="terms"
      title="terms for using candor"
      intro="candor is meant for socially mature, good-faith use. the product works best when users treat it as a place for honest conversation rather than exploitation, abuse, or impersonation."
    >
      <section className="space-y-3">
        <h2 className="text-lg font-medium text-foreground">good-faith use</h2>
        <p>
          do not use candor to harass, impersonate, manipulate, threaten, stalk, or knowingly distribute harmful or
      ...
      <section className="space-y-3">
        ...
        <p>
          candor may evolve its memory systems, routing, compatibility layers, or continuity features as the product
