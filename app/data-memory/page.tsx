...
export const metadata: Metadata = {
  ...
  description: "How Candor thinks about continuity, memory, and user control.",
};
...
export default function DataMemoryPage() {
  return (
    <TrustPageShell
      ...
      intro="candor's memory layer exists so the experience can deepen over time. the point is better relational continuity, not exhaustive surveillance."
    >
      <section className="space-y-3">
        <h2 className="text-lg font-medium text-foreground">memory is signal-shaped</h2>
        <p>
          candor gradually retains the parts that help with future coherence: patterns, social rhythm, chemistry
      ...
      <section className="space-y-3">
        ...
        <p>
          echo, continuity, and resonance change how much context candor can meaningfully hold across time. the idea is
      ...
      <section className="space-y-3">
        ...
        <p>
          memory should be understandable, deletable, and shaped around trust. candor is at its best when it feels
