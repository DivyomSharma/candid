...
export const metadata: Metadata = {
  title: "Safety & Ethics",
  description: "Candid's positioning on trust, safety, and emotionally mature interaction.",
};
...
export default function SafetyPage() {
  return (
    <TrustPageShell
      ...
      intro="candid is meant to feel alive, playful, and sometimes emotionally charged. it is not meant to become exploitative, dependency-driven, or explicit for its own sake."
    >
      <section className="space-y-3">
        <h2 className="text-lg font-medium text-foreground">what candid supports</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-medium text-foreground">what candid avoids</h2>
        <p>
      ...
      <section className="space-y-3">
        ...
        <p>
          candid should feel premium because it understands relational nuance, not because it pushes people into blurred
